...
SAVE_DESCRIPT="method1_106_fold4"
...
python main.py --lr=0.00002 --aug=1.0 --epoch=5 --batch_size=100 --batch_size_test=32 --image_T=1 --clip_frames=1 --optim=sgd --mode=2 \
               --patch_size=16 --cpus=8 --gpu=3 --data_dir=${DATA_DIR} --save_dir="${SAVE_DIR}" --fold=4 \
               --model="vivit_2" --description="fold4" --bacometer_val='Bacometer1' --bacometer_test='Bacometer2' \
               --val_sample='28'
