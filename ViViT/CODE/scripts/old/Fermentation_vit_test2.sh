#DATA_DIR="../TEST2/test/Uncontam"
#DATA_DIR="../TEST2/test/Contam/Contam1"
#DATA_DIR="../TEST2/test/Contam/Contam10"
#DATA_DIR="../TEST2/test/Contam/Contam25"
DATA_DIR="../TEST2/test/Contam/Contam50"

SAVE_DESCRIPT="experiment2_32batch"
