DATA_DIR="../TEST3/test/Uncontam"
#DATA_DIR="../TEST3/test/Contam/Contam1"
#DATA_DIR="../TEST3/test/Contam/Contam10"
#DATA_DIR="../TEST3/test/Contam/Contam25"
#DATA_DIR="../TEST3/test/Contam/Contam50"
