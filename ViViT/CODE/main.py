...
def arg_parse():
    ...
    parser.add_argument('--bacometer_val', type=str, default=None)
    parser.add_argument('--bacometer_test', type=str, default=None)
...
if __name__ == "__main__":
    ...
    loaders = SpeckleLoader(
            ...
            test=arg.test, baco_val=arg.bacometer_val, baco_test=arg.bacometer_test, val_sample=arg.val_sample
    )
